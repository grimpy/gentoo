...
# $Header: /var/cvsroot/gentoo-x86/sys-auth/consolekit/consolekit-0.4.2-r4.ebuild,v 1.3 2010/10/29 10:41:46 hwoarang Exp $
...
src_prepare() {
	epatch \
		...
		"${FILESDIR}"/${PN}-0.4.2-islocal-hack.patch
